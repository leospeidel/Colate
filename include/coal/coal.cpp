...
mut_fast_simplified_all(cxxopts::Options& options){
	...
	if(options.count("coal") > 0){
		...
		std::fill(coal_rates.begin(), coal_rates.end(), 1.0/20000.0);
		std::fill(coal_rates_num.begin(), coal_rates_num.end(), 0.0);
		std::fill(coal_rates_denom.begin(), coal_rates_denom.end(), 0.0);
	}
	...
	std::vector<int> age_shared_count(num_age_bins), age_notshared_count(num_age_bins);
	std::fill(age_shared_count.begin(), age_shared_count.end(), 0);
	std::fill(age_notshared_count.begin(), age_notshared_count.end(), 0);
