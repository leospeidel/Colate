...
class aDNA_EM{
  ...
  private:
    ...
    void get_tint(float age_begin, float age_end, float tmrca, std::vector<double>& t_int, std::vector<int>& ep_index, int& i_begin, int& i_end, int& i_tmrca);
  ...
  public:
    ...
    double EM_shared(float age_begin, float age_end, float tmrca, std::vector<float>& num, std::vector<float>& denom);
    double EM_notshared(float age_begin, float age_end, float tmrca, std::vector<float>& num, std::vector<float>& denom); 
